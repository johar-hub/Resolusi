...
function create($data){
    ...
    $creat ="INSERT INTO tb_barang 
        VALUES('', '$nama', '$brand', '$harga', '$gambar')";
    //KIRIM VARIABLE PESAN KE DATABASE
    mysqli_query($db, $creat);
...
function delete($id){
    // KONEKSI KE DATABASE
    global $db;
    // BUAT PESAN HAPUS DATA TABLE dengan ID yang dipilih
    $delete = "DELETE FROM tb_barang WHERE id = $id";
    // EKSEKUSI PESAN KE DATABASE
